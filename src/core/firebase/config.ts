...
import { getFirestore, doc, setDoc, serverTimestamp, collection, query, where, getDocs, enableNetwork, disableNetwork, orderBy, deleteDoc, limit, updateDoc, startAfter } from "firebase/firestore";
...
export { doc, setDoc, serverTimestamp, collection, query, where, getDocs, enableNetwork, disableNetwork, orderBy, deleteDoc, limit, updateDoc, startAfter };
